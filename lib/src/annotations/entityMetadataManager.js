...
var EntityMetadataManager = /** @class */ (function () {
    ...
    EntityMetadataManager.prototype.entry = function (originData, Type, isomorphism) {
        ...
        return originData.map(function (data) {
            ...
            members.forEach(function (item) {
                if (typeof data !== 'object' || isEmpty_1.default(data)) {
                    return;
                }
    ...
    EntityMetadataManager.prototype.reverse = function (instances, Type) {
        var _this = this;
        var members = this.getMembers(Type.prototype);
        if (!members) {
            throw new Error(UNREGISTER_DATATYPE);
        ...
        if (!Array.isArray(instances)) {
            return this.reverse([instances], Type)[0];
        }
        return instances.map(function (item) {
            if (typeof item !== 'object' || isEmpty_1.default(item)) {
                return undefined;
            }
            var store = {};
