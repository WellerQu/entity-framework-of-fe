...
var entityMetadataManager_1 = __importDefault(require("../entityMetadataManager"));
...
var member = function (fieldName, dataType) { return function (target, propertyName) {
    entityMetadataManager_1.default.register(target, metadataType_1.default.Member, {
