...
var EntityConfiguration = /** @class */ (function () {
    ...
    EntityConfiguration.prototype.fetchJSON = function (url, options, data) {
        return __awaiter(this, void 0, void 0, function () {
            var hasDollar, fetchTarget, fetchOptions;
            return __generator(this, function (_a) {
                hasDollar = !!(~url.indexOf('$'));
                if (hasDollar && isEmpty_1.default(data)) {
                    return [2 /*return*/, Promise.resolve(null)];
                }
                fetchTarget = this.parseUrl(url, data);
                fetchOptions = __assign({}, options, { headers: __assign({}, options.headers, { 'Content-Type': 'application/json' }) });
                if (fetchOptions.method !== 'GET') {
                    fetchOptions.body = JSON.stringify(data);
                }
                return [2 /*return*/, this.fetch(fetchTarget, fetchOptions).then(function (res) { return res.json(); })];
            });
        });
    };
