...
var EntityContext = /** @class */ (function () {
    ...
    EntityContext.prototype.clean = function () {
        var _this = this;
        var entitySetKeys = entityMetadataManager_1.default
            .getEntitySets(Reflect.getPrototypeOf(this))
            .map(function (item) { return item.propertyName; });
        entitySetKeys.forEach(function (key) {
            Reflect.get(_this, key).clean();
        });
        return this;
    };
    EntityContext.prototype.saveChanges = function () {
        return __awaiter(this, void 0, void 0, function () {
            var entitySetKeys;
            var _this = this;
            return __generator(this, function (_a) {
                entitySetKeys = entityMetadataManager_1.default
                    .getEntitySets(Reflect.getPrototypeOf(this))
                    .map(function (item) { return item.propertyName; });
                return [2 /*return*/, Promise.all(entitySetKeys
                        .map(function (key) { return Reflect.get(_this, key).synchronizeState(); })
