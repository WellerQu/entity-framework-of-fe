        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                _a = queryMeta.mapParameters, mapParameters = _a === void 0 ? function () {
                    ...
                    return a;
                } : _a, _b = queryMeta.mapEntity, mapEntity = _b === void 0 ? function (res) { return res.json(); } : _b;
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.ctx.configuration
                            ...
                            .then(function (res) {
                            return mapEntity(res).then(function (data) {
                                var first = Array.isArray(data) ? data[0] : data;
                                var entity = _this.attachOriginDataToEntitySet(first);
    ...
    EntitySet.prototype.synchronizeAddedState = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                _a = behavior.mapParameters, mapParameters = _a === void 0 ? identity : _a, _b = behavior.mapEntity, mapEntity = _b === void 0 ? function (res) { return res.json(); } : _b;
                params = mapParameters(members.reduce(function (params, m) {
                    Reflect.set(params, m.fieldName, Reflect.get(object, m.propertyName));
                    return params;
                }, {}));
                return [2 /*return*/, this.ctx.configuration.fetchData(behavior.url, { method: behavior.method }, params)
                        .then(mapEntity)
                        .then(function (res) {
