...
var EntitySet = /** @class */ (function () {
    ...
    EntitySet.prototype.add = function () {
        ...
        entities.filter(function (item) { return !!item; }).forEach(function (addedItem) {
            ...
            tracer.onPropertyBeforeChange(_this.onPropertyBeforeChange);
            tracer.onPropertyAfterChange(_this.onPropertyAfterChange);
    ...
    EntitySet.prototype.detach = function () {
        ...
        entities.filter(function (item) { return !!item; }).forEach(function (detachedItem) {
            ...
            if (stateTrace) {
                ...
                stateTrace.offPropertyBeforeChange(_this.onPropertyBeforeChange);
                stateTrace.offPropertyAfterChange(_this.onPropertyAfterChange);
                stateTrace.revoke();
            }
        });
        return this;
