...
var constraints_1 = __importDefault(require("./annotations/constraints"));
var EntitySet = /** @class */ (function () {
    ...
    EntitySet.prototype.synchronizeAddedState = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var object, identity, members, behavior, constraints, _a, mapParameters, _b, mapEntity, params;
            var _this = this;
            return __generator(this, function (_c) {
                ...
                constraints = entityMetadataManager_1.default.getMemberConstraints(object.constructor.prototype);
                if (!behavior) {
                    return [2 /*return*/, (Promise.reject(new Error(object.constructor.name + " \u6CA1\u6709\u914D\u7F6EAdd behavior")))];
                }
                _a = behavior.mapParameters, mapParameters = _a === void 0 ? identity : _a, _b = behavior.mapEntity, mapEntity = _b === void 0 ? function (p) { return p; } : _b;
                params = mapParameters(members.reduce(function (params, m) {
                    var value = Reflect.get(object, m.propertyName);
                    var allConstraints = constraints[m.propertyName];
                    if (!allConstraints) {
                        Reflect.set(params, m.fieldName, value);
                        return params;
                    }
                    if ((allConstraints & constraints_1.default.NON_EMPTY_ON_ADDED) === constraints_1.default.NON_EMPTY_ON_ADDED && !isEmpty_1.default(value)) {
                        Reflect.set(params, m.fieldName, value);
                        return params;
                    }
                    return params;
    ...
    EntitySet.prototype.synchronizeDeletedState = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                _a = behavior.mapParameters, mapParameters = _a === void 0 ? identity : _a, _b = behavior.mapEntity, mapEntity = _b === void 0 ? function (a) { return a; } : _b;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                ...
                params = mapParameters(members.reduce(function (params, m) {
                    ...
                    if ((allConstraints & constraints_1.default.NON_EMPTY_ON_MODIFIED) === constraints_1.default.NON_EMPTY_ON_MODIFIED && !isEmpty_1.default(value)) {
                        Reflect.set(params, m.fieldName, value);
                        return params;
                    }
                    return params;
