...
var EntitySet = /** @class */ (function () {
    ...
    EntitySet.prototype.entry = function (originData, entity) {
        ...
        keys.forEach(function (key) {
            ...
            Reflect.set(_this.wMap.get(entity) || entity, key, data);
        });
        return entity;
    };
    /**
     ...
     * @returns 填充数据的实例
     */
    EntitySet.prototype.fill = function (originData, entity) {
        var _this = this;
        var instance = entityMetadataManager_1.default.entry(originData, this.entityMetadata.type, true);
        if (!entity) {
            return instance;
        }
        var keys = Object.keys(instance);
