...
var EntitySet = /** @class */ (function () {
    ...
    EntitySet.prototype.applyConstraints = function (special, rawObject) {
        var members = entityMetadataManager_1.default.getMembers(rawObject.constructor.prototype);
        var constraints = entityMetadataManager_1.default.getMemberConstraints(rawObject.constructor.prototype);
