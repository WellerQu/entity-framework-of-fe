...
export { behavior, foreign, primary, navigator, member, set, metadataManager, MetadataType, Relationship, EntityConfiguration, EntityContext, EntitySet, EntityState };
